...
compileToAssemblerFile :: (String -> Program -> IO String) -> String -> String -> IO String
compileToAssemblerFile compiler filePath extension = do
  ...
  withFile filePath ReadMode (\handle -> do
    ...
    writeFile outputFile compiledProgram
    )
  return outputFile

compile :: (String -> Program -> IO String) -> String -> String -> IO String
...
mainH :: (String -> Program -> IO String) -> String -> (String -> IO ()) -> IO ()
